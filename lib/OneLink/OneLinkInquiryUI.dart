...
class OneLinkInquiryUI extends StatefulWidget {
  ...
  @override
  State<OneLinkInquiryUI> createState() => _OneLinkUIState();
}

class _OneLinkUIState extends State<OneLinkInquiryUI> {
  ...
  void initState() {
    ...
    print(widget.paymentStatuses);    _oneLinkData = widget.oneLinkData;
  ...
  Color getPaymentButtonColor() {
    final statuses =
    widget.paymentStatuses.map((e) => e.toLowerCase()).toList();
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        // Logo
                        Image.asset(
                          'assets/images/1Link-Inquiry.png',
                          height: 86,
                        ),
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            try {
                              final data = await AuthData.fetchOneLinkPaymentHealth(AuthData.OnelinkPaymentAPiLink, selectedTimer);

                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => OneLinkPaymentUI(oneLinkData: data, inquiryStatuses: widget.inquiryStatuses, paymentStatuses: widget.paymentStatuses,),
                                ),
                              );
                            } catch (e) {
